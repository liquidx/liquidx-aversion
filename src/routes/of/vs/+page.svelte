<script lang="ts">
	...
	import UserJoinForm from '$lib/multi-player/UserJoinForm.svelte';
	import type { GameMessage } from '$lib/multi-player/game';
	import PlayerBox from '$lib/multi-player/PlayerBox.svelte';
